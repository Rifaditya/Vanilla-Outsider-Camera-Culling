...
[![Minecraft 26.1.2](https://img.shields.io/badge/Minecraft-26.1.2-brightgreen?style=for-the-badge)](https://github.com/Rifaditya/Vanilla-Outsider-Camera-Culling/releases)

Dedicated Minecraft **26.1.2** subproject build of **Camera Culling**.
...
```
Compiled artifact will be output to `build/libs/` and auto-archived to `Archive Jar of all versions/MC 26.1.2/`.
