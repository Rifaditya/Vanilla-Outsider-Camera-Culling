# 🖥️ Graphical GUI Configuration (Minecraft 26.3)
...
To ensure Camera Culling never crashes dedicated servers or installations where YACL is absent, `ModMenuIntegration` implements deferred classloading:
...
If YACL is not installed, the game launches seamlessly and players can configure all settings via [[In-Game Commands|26.3-Commands-and-Configuration]] or by editing `config/camera-culling.json`.
