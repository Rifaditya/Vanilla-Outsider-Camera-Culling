# 🖥️ Графический интерфейс настроек (YACL) (Minecraft 26.2)
...
Если YACL не установлен, все настройки можно регулировать через [[команды и конфигурацию|ru_ru-26.2-Commands-and-Configuration]] или путем редактирования `config/camera-culling.json`.
