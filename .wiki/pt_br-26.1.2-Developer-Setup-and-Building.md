# 🛠️ Configuração de Desenvolvedor e Compilação (Minecraft 26.1.2)

🌐 **Languages**: [[🇺🇸 English|Home]] | [[🇨🇳 简体中文|zh_cn-Home]] | [[🇭🇰 繁體中文|zh_tw-Home]] | [[🇷🇺 Русский|ru_ru-Home]] | [[🇪🇸 Español|es_es-Home]] | [[🇩🇪 Deutsch|de_de-Home]] | [[🇫🇷 Français|fr_fr-Home]] | [[🇧🇷 Português|pt_br-Home]] | [[🇯🇵 日本語|ja_jp-Home]] | [[🇮🇩 Bahasa Indonesia|id_id-Home]] | [[🇰🇷 한국어|ko_kr-Home]]

Este guia técnico aborda os pré-requisitos de ambiente, ferramentas do Gradle Loom e instruções de compilação para construir o **Camera Culling** no **Minecraft 26.1.2**.
...
Abra um terminal no diretório do subprojeto `Camera Culling v26.1/Camera Culling 26.1`:
...
* JAR de Saída: `build/libs/vanilla-outsider-camera-culling-1.10.1+26.1.2.jar`
* Local de Arquivamento Automático: `Archive Jar of all versions/MC 26.1.2/`
* Sincronização com o Perfil do Modrinth: Instalado automaticamente no seu perfil local do inicializador (`Fabric 26.1.2/mods/`).
