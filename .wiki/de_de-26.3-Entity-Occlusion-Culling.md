...
| **Laub-Okklusion** | Solides Rendering und `BlockTags.LEAVES`-Blöcke verdecken Sichtlinien |
...
Anstelle eines einfachen Ein-Punkt-Raycasts, der dazu führen kann, dass Mobs an Blockkanten plötzlich aufploppen oder verschwinden, führt Camera Culling ein anatomisches Mehrpunkt-Sampling basierend auf dem gewählten [[Culling-Profil|de_de-26.3-Commands-and-Configuration]] durch:
...
In 26.3 übergibt `CullingRaycastHelper` direkt primitive Koordinaten:
```java
...
- [[Mob-Mengen-Overdraw-Schutz|de_de-26.3-Mob-Crowd-Overdraw-Defense]]
- [[Zeitliche Hysterese & Zero-Allocation|de_de-26.3-Temporal-Hysteresis-and-Zero-Allocation]]
