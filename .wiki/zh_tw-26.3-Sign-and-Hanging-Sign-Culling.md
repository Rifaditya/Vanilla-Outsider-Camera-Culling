# 🪧 雙面告示牌與懸掛告示牌文本剔除 (Minecraft 26.3)

🌐 **Languages**: [[🇺🇸 English|Home]] | [[🇨🇳 简体中文|zh_cn-Home]] | [[🇭🇰 繁體中文|zh_tw-Home]] | [[🇷🇺 Русский|ru_ru-Home]] | [[🇪🇸 Español|es_es-Home]] | [[🇩🇪 Deutsch|de_de-Home]] | [[🇫🇷 Français|fr_fr-Home]] | [[🇧🇷 Português|pt_br-Home]] | [[🇯🇵 日本語|ja_jp-Home]] | [[🇮🇩 Bahasa Indonesia|id_id-Home]] | [[🇰🇷 한국어|ko_kr-Home]]

在 Minecraft 26.3 中，告示牌與懸掛告示牌具備雙面文本渲染特性（`SignTextSlot.FRONT` 與 `SignTextSlot.BACK`）。預設情況下，遊戲的字型渲染引擎會同時對**正反兩面**的字元四邊形、染料顏色以及螢光輪廓進行字距排版與光柵化渲染——即使玩家正對著緊貼牆壁的告示牌正面也是如此。
...
- [[方塊實體遮擋剔除|zh_tw-26.3-Block-Entity-Culling]]
