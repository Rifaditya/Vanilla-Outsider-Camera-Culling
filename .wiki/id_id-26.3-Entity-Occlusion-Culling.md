# 🧱 Culling Oklusi Entitas (Minecraft 26.3)

🌐 **Languages**: [[🇺🇸 English|Home]] | [[🇨🇳 简体中文|zh_cn-Home]] | [[🇭🇰 繁體中文|zh_tw-Home]] | [[🇷🇺 Русский|ru_ru-Home]] | [[🇪🇸 Español|es_es-Home]] | [[🇩🇪 Deutsch|de_de-Home]] | [[🇫🇷 Français|fr_fr-Home]] | [[🇧🇷 Português|pt_br-Home]] | [[🇯🇵 日本語|ja_jp-Home]] | [[🇮🇩 Bahasa Indonesia|id_id-Home]] | [[🇰🇷 한국어|ko_kr-Home]]

Dalam Minecraft 26.3, pipeline rendering entitas klien mengekstrak render state (`EntityRenderState`) untuk semua entitas di dalam frustum kamera—bahkan jika entitas tersebut tersembunyi di balik gunung, dinding batu tebal, atau dungeon bawah tanah. **Camera Culling** mencegat pemeriksaan ini untuk mencegah mob yang terhalang mengonsumsi pemrosesan geometri CPU dan draw call GPU.
...
Alih-alih menggunakan raycast titik tunggal sederhana yang menyebabkan mob muncul dan hilang secara mendadak di sudut bangunan, Camera Culling menjalankan pengambilan sampel anatomis multi-titik berdasarkan [[Profil Culling|id_id-26.3-Commands-and-Configuration]] yang dipilih:
...
Dalam 26.3, `CullingRaycastHelper` meneruskan koordinat primitif mentah:
```java
...
- [[Pertahanan Overdraw Kerumunan Mob|id_id-26.3-Mob-Crowd-Overdraw-Defense]]
- [[Histeresis Temporal & Matematika|id_id-26.3-Temporal-Hysteresis-and-Zero-Allocation]]
- [[Imunitas Bos & Daftar Hitam|id_id-26.3-Boss-and-Blacklist-Immunity]]
