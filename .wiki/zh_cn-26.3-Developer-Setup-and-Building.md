# 🛠️ 开发者环境与构建 (Minecraft 26.3)

🌐 **Languages**: [[🇺🇸 English|Home]] | [[🇨🇳 简体中文|zh_cn-Home]] | [[🇭🇰 繁體中文|zh_tw-Home]] | [[🇷🇺 Русский|ru_ru-Home]] | [[🇪🇸 Español|es_es-Home]] | [[🇩🇪 Deutsch|de_de-Home]] | [[🇫🇷 Français|fr_fr-Home]] | [[🇧🇷 Português|pt_br-Home]] | [[🇯🇵 日本語|ja_jp-Home]] | [[🇮🇩 Bahasa Indonesia|id_id-Home]] | [[🇰🇷 한국어|ko_kr-Home]]

本技术指南详细介绍了在 **Minecraft 26.3** 上编译和构建 **Camera Culling** 所需的先决条件、Gradle Loom 工具链配置以及具体操作指令。
...
在终端中进入 `Camera Culling v26.3/Camera Culling 26.3` 子项目目录：
...
* 编译产物 JAR：`build/libs/vanilla-outsider-camera-culling-1.10.0+26.3.jar`
* 自动归档保存路径：`Archive Jar of all versions/MC 26.3/`
* 本地启动器配置目录同步：自动安装至本地客户端目录（`Fabric 26.3ish/mods/`）。
