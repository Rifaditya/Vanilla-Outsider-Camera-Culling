# 🧱 Entity Occlusion Culling (Minecraft 26.1.2)

In Minecraft 26.1.2, client entity rendering extracts render states for all entities inside the camera frustum—even when obscured behind caves, cliffs, or builds. **Camera Culling** intercepts this check to prevent occluded mobs from consuming CPU geometry processing and GPU draw calls.
...
Camera Culling performs multi-point anatomical sampling based on the selected [[Culling Profile|26.1.2-Commands-and-Configuration]]:
...
In 26.1.2, `CullingRaycastHelper` passes raw primitive coordinates:
```java
...
- [[Mob Crowd Overdraw Defense|26.1.2-Mob-Crowd-Overdraw-Defense]]
- [[Temporal Hysteresis & Math|26.1.2-Temporal-Hysteresis-and-Zero-Allocation]]
- [[Boss & Blacklist Immunity|26.1.2-Boss-and-Blacklist-Immunity]]
