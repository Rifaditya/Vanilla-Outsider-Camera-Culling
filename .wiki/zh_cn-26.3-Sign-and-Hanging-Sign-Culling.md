# 🪧 双面告示牌与悬挂告示牌文本剔除 (Minecraft 26.3)

🌐 **Languages**: [[🇺🇸 English|Home]] | [[🇨🇳 简体中文|zh_cn-Home]] | [[🇭🇰 繁體中文|zh_tw-Home]] | [[🇷🇺 Русский|ru_ru-Home]] | [[🇪🇸 Español|es_es-Home]] | [[🇩🇪 Deutsch|de_de-Home]] | [[🇫🇷 Français|fr_fr-Home]] | [[🇧🇷 Português|pt_br-Home]] | [[🇯🇵 日本語|ja_jp-Home]] | [[🇮🇩 Bahasa Indonesia|id_id-Home]] | [[🇰🇷 한국어|ko_kr-Home]]

在 Minecraft 26.3 中，告示牌与悬挂告示牌具备双面文本渲染特性（`SignTextSlot.FRONT` 与 `SignTextSlot.BACK`）。默认情况下，游戏的字体渲染引擎会同时对**正反两面**的字符四边形、染料颜色以及荧光轮廓进行字距排版与光栅化渲染——即使玩家正面对着紧贴墙壁的告示牌正面也是如此。
...
- [[方块实体遮挡剔除|zh_cn-26.3-Block-Entity-Culling]]
