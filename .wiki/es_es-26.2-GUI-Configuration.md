# 🖥️ Configuración gráfica GUI (YACL) (Minecraft 26.2)
...
Si YACL no está instalado, todos los ajustes se pueden modificar mediante [[comandos y configuración|es_es-26.2-Commands-and-Configuration]] o editando `config/camera-culling.json`.
...
- [[Registro de depuración y diagnósticos|es_es-26.2-Debug-Logging-and-Diagnostics]]
