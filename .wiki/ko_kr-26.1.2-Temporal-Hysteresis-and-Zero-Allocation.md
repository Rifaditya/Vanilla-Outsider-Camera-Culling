# ⏱️ 시간적 히스테리시스 및 제로 할당 수학 (Minecraft 26.1.2)

🌐 **Languages**: [[🇺🇸 English|Home]] | [[🇨🇳 简体中文|zh_cn-Home]] | [[🇭🇰 繁體中文|zh_tw-Home]] | [[🇷🇺 Русский|ru_ru-Home]] | [[🇪🇸 Español|es_es-Home]] | [[🇩🇪 Deutsch|de_de-Home]] | [[🇫🇷 Français|fr_fr-Home]] | [[🇧🇷 Português|pt_br-Home]] | [[🇯🇵 日本語|ja_jp-Home]] | [[🇮🇩 Bahasa Indonesia|id_id-Home]] | [[🇰🇷 한국어|ko_kr-Home]]

초고속 차폐 컬링은 두 가지 흔한 성능 결함을 유발할 수 있습니다:
1. **카메라 스침 깜빡임 (Z-파이팅 / 경계 팝인)**: 블록 모서리를 가로지르는 미세한 카메라 회전으로 인해 교대 프레임에서 엔티티가 렌더링 상태와 비렌더링 상태 사이를 빠르게 깜빡일 수 있습니다.
2. **가비지 컬렉션 버벅임 스파이크**: 레이캐스팅 도중 `new Vec3()` 객체가 지속적으로 할당되면 JVM Young-Gen 가비지 컬렉션 일시 중단이 발생합니다.
...
- [[디버그 로깅 및 진단 추적|ko_kr-26.1.2-Debug-Logging-and-Diagnostics]]
