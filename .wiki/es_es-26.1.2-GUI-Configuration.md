# 🖥️ Configuración gráfica GUI (YACL) (Minecraft 26.1.2)
...
Si YACL no está instalado, todos los ajustes se pueden modificar mediante [[comandos y configuración|es_es-26.1.2-Commands-and-Configuration]] o editando `config/camera-culling.json`.
