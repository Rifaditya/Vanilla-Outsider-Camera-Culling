# 🧱 Oclusão de Entidades (Minecraft 26.3)

🌐 **Languages**: [[🇺🇸 English|Home]] | [[🇨🇳 简体中文|zh_cn-Home]] | [[🇭🇰 繁體中文|zh_tw-Home]] | [[🇷🇺 Русский|ru_ru-Home]] | [[🇪🇸 Español|es_es-Home]] | [[🇩🇪 Deutsch|de_de-Home]] | [[🇫🇷 Français|fr_fr-Home]] | [[🇧🇷 Português|pt_br-Home]] | [[🇯🇵 日本語|ja_jp-Home]] | [[🇮🇩 Bahasa Indonesia|id_id-Home]] | [[🇰🇷 한국어|ko_kr-Home]]

No Minecraft 26.3, o pipeline de renderização de entidades do cliente extrai estados de renderização (`EntityRenderState`) para todas as entidades dentro do frustum da câmera — mesmo se estiverem ocultas atrás de montanhas, paredes espessas de pedra ou masmorras subterrâneas. O **Camera Culling** intercepta essa verificação para evitar que mobs ocluídos consumam processamento de geometria na CPU e chamadas de desenho (draw calls) na GPU.
...
Em vez de um raycast simplista de ponto único que faz os mobs piscarem nas esquinas, o Camera Culling realiza amostragem anatômica multiponto com base no [[Perfil de Culling|pt_br-26.3-Commands-and-Configuration]] selecionado:
...
No 26.3, o `CullingRaycastHelper` passa diretamente as coordenadas primitivas:
```java
...
- [[Defesa de Sobredesenho de Multidões|pt_br-26.3-Mob-Crowd-Overdraw-Defense]]
- [[Histerese Temporal e Alocação Zero|pt_br-26.3-Temporal-Hysteresis-and-Zero-Allocation]]
