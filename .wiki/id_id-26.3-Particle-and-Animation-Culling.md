# ✨ Culling Oklusi Partikel & Animasi (Minecraft 26.3)
...
1. **Gelembung Keamanan Proksimitas (4.0m)**: Partikel yang dipancarkan dalam radius 4 meter dari kamera (misalnya pusaran ramuan, debu lari cepat, tebasan serangan) di-render tanpa syarat dalam waktu $< 0.0001\mu\text{s}$.
