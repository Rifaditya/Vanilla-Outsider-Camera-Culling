# ✨ Oclusión de partículas y animaciones (Minecraft 26.3)
...
1. **Burbuja de seguridad cercana (4.0m)**: Las partículas emitidas a menos de 4 metros de la cámara (por ejemplo, remolinos de pociones, polvo al correr, estelas de ataque) se renderizan incondicionalmente en $< 0.0001\mu\text{s}$.
...
Las animaciones de atlas de texturas (linternas marinas animadas, agua/lava fluyendo, prismarina, fuego, brújula, reloj) consumen ancho de banda de GPU al ciclar los fotogramas.
