...
若环境中未安装 YACL，游戏依然能够无缝启动，玩家可以通过[[游戏内指令|zh_cn-26.2-Commands-and-Configuration]]或直接编辑 `config/camera-culling.json` 调整所有配置。

---

## 🔗 相关页面

- [[指令与配置系统|zh_cn-26.2-Commands-and-Configuration]]
- [[调试日志与诊断追踪|zh_cn-26.2-Debug-Logging-and-Diagnostics]]
