# 🪧 Culling Teks Papan Tanda & Tanda Gantung 2 Sisi (Minecraft 26.3)

🌐 **Languages**: [[🇺🇸 English|Home]] | [[🇨🇳 简体中文|zh_cn-Home]] | [[🇭🇰 繁體中文|zh_tw-Home]] | [[🇷🇺 Русский|ru_ru-Home]] | [[🇪🇸 Español|es_es-Home]] | [[🇩🇪 Deutsch|de_de-Home]] | [[🇫🇷 Français|fr_fr-Home]] | [[🇧🇷 Português|pt_br-Home]] | [[🇯🇵 日本語|ja_jp-Home]] | [[🇮🇩 Bahasa Indonesia|id_id-Home]] | [[🇰🇷 한국어|ko_kr-Home]]

Dalam Minecraft 26.3, papan tanda dan tanda gantung memiliki kapabilitas teks dua sisi (`SignTextSlot.FRONT` dan `SignTextSlot.BACK`). Secara bawaan, mesin render font game mengurai, melakukan kerning, dan me-render quad teks, pewarna, serta garis luar bercahaya untuk **kedua** sisi secara bersamaan—bahkan ketika pemain melihat langsung ke sisi depan papan tanda yang menempel di dinding.

**Camera Culling** mengatasi ini dengan menghitung perkalian titik vektor normal ($\vec{N} \cdot \vec{V}$) dan fast-pass teks kosong untuk tidak me-render permukaan teks papan tanda yang tidak terlihat atau kosong.
...
Jika pemain hanya menulis teks pada satu sisi papan tanda (atau menempatkan tanda tanpa teks sebagai penghalang/dekorasi), Camera Culling memeriksa 4 baris teks:
```java
...
- [[Culling Entitas Blok|id_id-26.3-Block-Entity-Culling]]
- [[Perintah & Konfigurasi|id_id-26.3-Commands-and-Configuration]]
