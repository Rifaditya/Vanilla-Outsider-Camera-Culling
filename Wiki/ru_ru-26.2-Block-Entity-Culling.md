# 📦 Отсечение блочных сущностей (Minecraft 26.2)
...
| Свойство | Значение |
| :--- | :--- |
| **Целевой конвейер** | `BlockEntityRenderDispatcher.tryExtractRenderState(BlockEntity, float, CrumblingOverlay, boolean)` |
...
- [[Отсечение текста табличек|ru_ru-26.2-Sign-and-Hanging-Sign-Culling]]
