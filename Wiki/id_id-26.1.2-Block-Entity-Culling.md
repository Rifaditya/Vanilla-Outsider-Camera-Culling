# 📦 Culling Oklusi Entitas Blok (Minecraft 26.1.2)
...
| Properti | Nilai |
| :--- | :--- |
| **Target Pipeline** | `BlockEntityRenderDispatcher.tryExtractRenderState(BlockEntity, float, CrumblingOverlay)` (3 argumen) |
...
- [[Culling Teks Papan Tanda|id_id-26.1.2-Sign-and-Hanging-Sign-Culling]]
