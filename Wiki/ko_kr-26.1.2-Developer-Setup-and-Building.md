# 🛠️ 개발자 환경 설정 및 빌드 (Minecraft 26.1.2)

🌐 **Languages**: [[🇺🇸 English|Home]] | [[🇨🇳 简体中文|zh_cn-Home]] | [[🇭🇰 繁體中文|zh_tw-Home]] | [[🇷🇺 Русский|ru_ru-Home]] | [[🇪🇸 Español|es_es-Home]] | [[🇩🇪 Deutsch|de_de-Home]] | [[🇫🇷 Français|fr_fr-Home]] | [[🇧🇷 Português|pt_br-Home]] | [[🇯🇵 日本語|ja_jp-Home]] | [[🇮🇩 Bahasa Indonesia|id_id-Home]] | [[🇰🇷 한국어|ko_kr-Home]]

이 기술 가이드는 **Minecraft 26.1.2**에서 **Camera Culling**을 빌드하기 위한 환경 필수 구성 요소, Gradle Loom 도구 및 컴파일 지침을 다룹니다.
...
`Camera Culling v26.1/Camera Culling 26.1` 서브프로젝트 디렉터리에서 터미널을 엽니다:
...
* 출력 JAR: `build/libs/vanilla-outsider-camera-culling-1.10.1+26.1.2.jar`
* 자동 아카이브 경로: `Archive Jar of all versions/MC 26.1.2/`
* Modrinth 프로필 동기화: 로컬 런처 프로필(`Fabric 26.1.2/mods/`)에 자동으로 설치됩니다.
