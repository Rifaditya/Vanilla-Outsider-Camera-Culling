# 🖥️ Konfigurasi GUI Grafis (Minecraft 26.1.2)
...
Jika YACL tidak terpasang, semua pengaturan dapat disesuaikan melalui [[Perintah & Konfigurasi|id_id-26.1.2-Commands-and-Configuration]] atau dengan mengedit berkas `config/camera-culling.json`.
