# 🖥️ Configuração Gráfica GUI (YACL) (Minecraft 26.1.2)
...
Se o YACL não estiver instalado, o jogo inicializa perfeitamente e os jogadores podem ajustar todas as opções através dos [[Comandos e Configuração|pt_br-26.1.2-Commands-and-Configuration]] ou editando `config/camera-culling.json`.
