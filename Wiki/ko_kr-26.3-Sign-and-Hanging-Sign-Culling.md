# 🪧 양면 표지판 및 매다는 표지판 텍스트 컬링 (Minecraft 26.3)

🌐 **Languages**: [[🇺🇸 English|Home]] | [[🇨🇳 简体中文|zh_cn-Home]] | [[🇭🇰 繁體中文|zh_tw-Home]] | [[🇷🇺 Русский|ru_ru-Home]] | [[🇪🇸 Español|es_es-Home]] | [[🇩🇪 Deutsch|de_de-Home]] | [[🇫🇷 Français|fr_fr-Home]] | [[🇧🇷 Português|pt_br-Home]] | [[🇯🇵 日本語|ja_jp-Home]] | [[🇮🇩 Bahasa Indonesia|id_id-Home]] | [[🇰🇷 한국어|ko_kr-Home]]

Minecraft 26.3에서 표지판과 매다는 표지판은 양면 텍스트 기능(`SignTextSlot.FRONT` 및 `SignTextSlot.BACK`)을 갖추고 있습니다. 기본적으로 게임의 폰트 렌더링 엔진은 플레이어가 벽에 붙은 표지판의 전면만을 바라보고 있을 때조차 **양쪽** 면의 텍스트 쿼드, 염료 및 발광 윤곽선을 동시에 파싱, 자간 조정 및 렌더링합니다.

**Camera Culling**은 법선 벡터 내적($\vec{N} \cdot \vec{V}$)과 빈 텍스트 패스트 패스를 계산하여 보이지 않거나 비어 있는 표지판 텍스트 면을 렌더링하지 않도록 해결합니다.
...
플레이어가 표지판의 한쪽에만 글을 작성했거나(또는 장식/방벽용으로 텍스트 없이 배치한 경우), Camera Culling은 4개의 텍스트 줄을 검사합니다:
```java
...
- [[블록 엔티티 차폐 컬링|ko_kr-26.3-Block-Entity-Culling]]
