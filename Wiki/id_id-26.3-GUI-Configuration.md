# 🖥️ Konfigurasi GUI Grafis (Minecraft 26.3)
...
Untuk memastikan Camera Culling tidak pernah mengalami crash pada dedicated server atau instalasi di mana YACL tidak tersedia, `ModMenuIntegration` menerapkan pemuatan kelas tertunda (*deferred classloading*):
...
Jika YACL tidak terpasang, game akan tetap berjalan mulus tanpa masalah dan pemain dapat mengonfigurasi semua pengaturan melalui [[Perintah Dalam Game|id_id-26.3-Commands-and-Configuration]] atau dengan mengedit berkas `config/camera-culling.json`.
