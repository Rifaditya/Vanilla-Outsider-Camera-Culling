# 📦 ブロックエンティティの間引き (Minecraft 26.3)

🌐 **Languages**: [[🇺🇸 English|Home]] | [[🇨🇳 简体中文|zh_cn-Home]] | [[🇭🇰 繁體中文|zh_tw-Home]] | [[🇷🇺 Русский|ru_ru-Home]] | [[🇪🇸 Español|es_es-Home]] | [[🇩🇪 Deutsch|de_de-Home]] | [[🇫🇷 Français|fr_fr-Home]] | [[🇧🇷 Português|pt_br-Home]] | [[🇯🇵 日本語|ja_jp-Home]] | [[🇮🇩 Bahasa Indonesia|id_id-Home]] | [[🇰🇷 한국어|ko_kr-Home]]

ブロックエンティティ（チェスト、エンダーチェスト、看板、旗、頭蓋骨、飾り壺、鐘、ビーコン）は動的レンダリング要素です。バニラのチャンクメッシュコンパイルをバイパスするため、毎フレーム個別の描画コールを発行します。数百個のチェストが並ぶ倉庫や自動仕分け施設では、これが深刻なGPUボトルネックの原因となります。
...
| 項目 | 設定値 |
| :--- | :--- |
| **対象パイプライン** | `BlockEntityRenderDispatcher.tryExtractRenderState(...)` |
...
- [[看板と吊り看板のテキスト間引き|ja_jp-26.3-Sign-and-Hanging-Sign-Culling]]
- [[エンティティの遮蔽カリング|ja_jp-26.3-Entity-Occlusion-Culling]]
