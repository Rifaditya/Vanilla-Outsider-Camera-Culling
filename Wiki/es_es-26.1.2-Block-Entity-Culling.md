# 📦 Oclusión de entidades de bloque (Minecraft 26.1.2)
...
| Propiedad | Valor |
| :--- | :--- |
| **Canal de destino** | `BlockEntityRenderDispatcher.tryExtractRenderState(BlockEntity, float, CrumblingOverlay)` (3 argumentos) |
...
- [[Oclusión de texto en carteles|es_es-26.1.2-Sign-and-Hanging-Sign-Culling]]
