# 📦 블록 엔티티 차폐 컬링 (Minecraft 26.1.2)

🌐 **Languages**: [[🇺🇸 English|Home]] | [[🇨🇳 简体中文|zh_cn-Home]] | [[🇭🇰 繁體中文|zh_tw-Home]] | [[🇷🇺 Русский|ru_ru-Home]] | [[🇪🇸 Español|es_es-Home]] | [[🇩🇪 Deutsch|de_de-Home]] | [[🇫🇷 Français|fr_fr-Home]] | [[🇧🇷 Português|pt_br-Home]] | [[🇯🇵 日本語|ja_jp-Home]] | [[🇮🇩 Bahasa Indonesia|id_id-Home]] | [[🇰🇷 한국어|ko_kr-Home]]

블록 엔티티(상자, 엔더 상자, 표지판, 현수막, 해골, 장식된 도자기, 종 및 신호기)는 매 프레임 개별 드로우 콜을 제출합니다. 대규모 창고나 자동 분류 시설에서는 심각한 GPU 드로우 콜 부하가 발생합니다.
...
| 속성 | 값 |
| :--- | :--- |
| **대상 파이프라인** | `BlockEntityRenderDispatcher.tryExtractRenderState(BlockEntity, float, CrumblingOverlay)` (3개의 인자) |
...
### 2. 가시선 레이캐스트 검사
`MEDIUM`, `HIGH`, `SUPER` 프로필(`cullAllBlockEntities = true`)에서 Camera Culling은 카메라 위치에서 블록 엔티티 중심 $(X + 0.5, Y + 0.5, Z + 0.5)$으로 광선을 투사하여 가려진 렌더 상태를 폐기합니다.

---

## 🔗 관련 페이지

- [[표지판 및 매다는 표지판 텍스트 컬링|ko_kr-26.1.2-Sign-and-Hanging-Sign-Culling]]
