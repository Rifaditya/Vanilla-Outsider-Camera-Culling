...
| 属性 | 设定值 |
| :--- | :--- |
| **目标管线** | `BlockEntityRenderDispatcher.tryExtractRenderState(BlockEntity, float, CrumblingOverlay) (3 arguments)` （接受 3 个参数） |
...
- [[告示牌与悬挂告示牌文本剔除|zh_cn-26.1.2-Sign-and-Hanging-Sign-Culling]]
