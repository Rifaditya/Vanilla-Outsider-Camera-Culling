# 📦 Block-Entity-Culling (Minecraft 26.1.2)
...
| Eigenschaft | Wert |
| :--- | :--- |
| **Ziel-Pipeline** | `BlockEntityRenderDispatcher.tryExtractRenderState(BlockEntity, float, CrumblingOverlay)` (3 Argumente) |
...
- [[Schild- & Hängeschild-Text-Culling|de_de-26.1.2-Sign-and-Hanging-Sign-Culling]]
