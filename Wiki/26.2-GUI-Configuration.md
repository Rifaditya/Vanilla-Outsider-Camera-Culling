# 🖥️ Graphical GUI Configuration (Minecraft 26.2)
...
If YACL is not installed, all settings can be adjusted via [[Commands & Configuration|26.2-Commands-and-Configuration]] or by editing `config/camera-culling.json`.
