# 🛠️ Настройка разработчика и сборка (Minecraft 26.2)

🌐 **Languages**: [[🇺🇸 English|Home]] | [[🇨🇳 简体中文|zh_cn-Home]] | [[🇭🇰 繁體中文|zh_tw-Home]] | [[🇷🇺 Русский|ru_ru-Home]] | [[🇪🇸 Español|es_es-Home]] | [[🇩🇪 Deutsch|de_de-Home]] | [[🇫🇷 Français|fr_fr-Home]] | [[🇧🇷 Português|pt_br-Home]] | [[🇯🇵 日本語|ja_jp-Home]] | [[🇮🇩 Bahasa Indonesia|id_id-Home]] | [[🇰🇷 한국어|ko_kr-Home]]

В этом руководстве описаны предварительные требования к окружению, инструментарий Gradle Loom и инструкции по компиляции **Camera Culling** для **Minecraft 26.2**.
...
Откройте терминал в директории подпроекта `Camera Culling v26.2/Camera Culling 26.2`:
...
* Выходной JAR: `build/libs/vanilla-outsider-camera-culling-1.10.0+26.2.jar`
* Расположение автоархива: `Archive Jar of all versions/MC 26.2/`
* Синхронизация с профилем Modrinth: Автоматически копируется в локальный профиль лаунчера (`Fabric 26.2 (1)/mods/`).
...
- [[API и интеграция модов|ru_ru-26.2-API-and-Integration]]
