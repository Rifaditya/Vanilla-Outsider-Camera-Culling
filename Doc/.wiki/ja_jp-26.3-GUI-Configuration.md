# 🖥️ グラフィカルGUI設定 (YACL) (Minecraft 26.3)
...
YACL がインストールされていない場合でも、ゲームは通常通り起動し、すべての設定項目は[[ゲーム内コマンド|ja_jp-26.3-Commands-and-Configuration]]または `config/camera-culling.json` の直接編集によって設定可能です。
