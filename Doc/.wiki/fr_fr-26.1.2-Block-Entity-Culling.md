# 📦 Occlusion des entités de bloc (Minecraft 26.1.2)
...
| Propriété | Valeur |
| :--- | :--- |
| **Pipeline cible** | `BlockEntityRenderDispatcher.tryExtractRenderState(BlockEntity, float, CrumblingOverlay)` (3 arguments) |
...
- [[Occlusion de texte des panneaux|fr_fr-26.1.2-Sign-and-Hanging-Sign-Culling]]
- [[Occlusion des entités|fr_fr-26.1.2-Entity-Occlusion-Culling]]
