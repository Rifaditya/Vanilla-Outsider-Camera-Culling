# 🖥️ Графический интерфейс настроек (YACL) (Minecraft 26.3)
...
Чтобы гарантировать, что Camera Culling никогда не приведет к сбою выделенных серверов или установок без YACL, `ModMenuIntegration` реализует отложенную загрузку классов:
```java
...
Если YACL не установлен, игра запускается без ошибок, и игроки могут настраивать все параметры через [[внутриигровые команды|ru_ru-26.3-Commands-and-Configuration]] или путем редактирования `config/camera-culling.json`.
...
- [[Отладка и диагностика|ru_ru-26.3-Debug-Logging-and-Diagnostics]]
