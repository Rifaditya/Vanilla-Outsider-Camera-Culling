# 🖥️ Configuration graphique GUI (YACL) (Minecraft 26.2)
...
Si YACL n'est pas installé, le jeu démarre parfaitement et les joueurs peuvent configurer tous les paramètres via les [[Commandes en jeu|fr_fr-26.2-Commands-and-Configuration]] ou en éditant le fichier `config/camera-culling.json`.
