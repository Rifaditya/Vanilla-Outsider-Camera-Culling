# 📦 Oclusão de Entidades de Bloco (Minecraft 26.2)
...
| Propriedade | Valor |
| :--- | :--- |
| **Pipeline Alvo** | `BlockEntityRenderDispatcher.tryExtractRenderState(BlockEntity, float, CrumblingOverlay, boolean)` |
...
- [[Oclusão de Texto de Placas|pt_br-26.2-Sign-and-Hanging-Sign-Culling]]
- [[Oclusão de Entidades|pt_br-26.2-Entity-Occlusion-Culling]]
