# 📦 ブロックエンティティの間引き (Minecraft 26.1.2)
...
| 項目 | 設定値 |
| :--- | :--- |
| **対象パイプライン** | `BlockEntityRenderDispatcher.tryExtractRenderState(BlockEntity, float, CrumblingOverlay)` (引数3個) |
...
- [[看板と吊り看板のテキスト間引き|ja_jp-26.1.2-Sign-and-Hanging-Sign-Culling]]
