# 🖥️ Grafische GUI-Konfiguration (YACL) (Minecraft 26.1.2)
...
Wenn YACL nicht installiert ist, startet das Spiel reibungslos und die Spieler können alle Einstellungen über [[In-Game-Befehle|de_de-26.1.2-Commands-and-Configuration]] oder durch Bearbeiten der Datei `config/camera-culling.json` anpassen.
...
- [[Debug-Logging & Diagnose|de_de-26.1.2-Debug-Logging-and-Diagnostics]]
