# 🪧 Oclusão de Texto em Placas de Dois Lados (Minecraft 26.3)

🌐 **Languages**: [[🇺🇸 English|Home]] | [[🇨🇳 简体中文|zh_cn-Home]] | [[🇭🇰 繁體中文|zh_tw-Home]] | [[🇷🇺 Русский|ru_ru-Home]] | [[🇪🇸 Español|es_es-Home]] | [[🇩🇪 Deutsch|de_de-Home]] | [[🇫🇷 Français|fr_fr-Home]] | [[🇧🇷 Português|pt_br-Home]] | [[🇯🇵 日本語|ja_jp-Home]] | [[🇮🇩 Bahasa Indonesia|id_id-Home]] | [[🇰🇷 한국어|ko_kr-Home]]

No Minecraft 26.3, placas e placas suspensas possuem suporte a texto nos dois lados (`SignTextSlot.FRONT` e `SignTextSlot.BACK`). Por padrão, o motor de renderização de fontes do jogo processa, faz kerning e renderiza quads de texto, corantes e contornos brilhantes para **ambos** os lados simultaneamente — mesmo quando o jogador está olhando diretamente para a frente de uma placa fixada na parede.

O **Camera Culling** resolve isso calculando produtos escalares de vetores normais ($\vec{N} \cdot \vec{V}$) e passagens rápidas de texto vazio para deixar de renderizar faces de texto de placas não vistas ou em branco.
...
| **Passagem Rápida Vazia** | Pula automaticamente faces em branco com zero caracteres que não sejam espaços em branco |
...
- [[Oclusão de Entidades de Bloco|pt_br-26.3-Block-Entity-Culling]]
