...
| 속성 | 값 |
| :--- | :--- |
| **대상 파이프라인** | `BlockEntityRenderDispatcher.tryExtractRenderState(BlockEntity, float, CrumblingOverlay, boolean)` |
...
- [[표지판 및 매다는 표지판 텍스트 컬링|ko_kr-26.2-Sign-and-Hanging-Sign-Culling]]
- [[엔티티 차폐 컬링|ko_kr-26.2-Entity-Occlusion-Culling]]
