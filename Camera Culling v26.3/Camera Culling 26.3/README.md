...
[![Minecraft 26.3](https://img.shields.io/badge/Minecraft-26.3-brightgreen?style=for-the-badge)](https://github.com/Rifaditya/Vanilla-Outsider-Camera-Culling/releases)

Dedicated Minecraft **26.3** subproject build of **Camera Culling**.
...
- **2-Sided Sign & Hanging Sign Text Culling**: Skips font rendering on the occluded back side of signs (`SignTextSlot` API).
...
```
Compiled artifact will be output to `build/libs/` and auto-archived to `Archive Jar of all versions/MC 26.3/`.
